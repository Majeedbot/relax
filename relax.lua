...
return {
Lock     = '[- -『 M,A Source』 .](https://t.me/majeed8888)\n*ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه المسح *',
unLock   = '[- -『 M,A Source』 .](https://t.me/majeed8888)\n*ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- -『 M,A Source』 .](https://t.me/majeed8888)\n*ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه الكتم *',
lockKid  = '[- -『 M,A Source』 .](https://t.me/majeed8888)\n*ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه التقييد *',
lockKick = '[- -『 M,A Source』 .](https://t.me/majeed8888)\n*ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه الطرد *',
Reply    = '[- -『 M,A Source』 .](https://t.me/majeed8888)\n*ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ\n⌔︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
elseif tonumber(msg.sender.user_id) == 784938371 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(relax..'majeed8888:Channel:Join')}, },}}
...
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙جاري استرجاع المشتركين والمجموعةات ...')
Y = 0
...
--download('https://raw.githubusercontent.com/majeedbot/relax/main/relax.lua','relax.lua')
...
local Texting = {'ملاك وناسيك بمجموعةنه??',"حلغوم والله☹️ ","اطلق صوره🐼❤️","كيكك والله🥺","لازك بيها غيرها عاد😒",}
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙هاذا الامر يخص { '..Controller_Num(2)..' , مالك المجموعة }* ',"md",true)  
end
...
photo = "https://t.me/c/1506524986/311"
local T =[[
ٴ•━━ ━━ ━━ ━━ ━━ ━━•ٴ 
]]
keyboard = {} 
...
{
{text = '𝗗𝗲𝗩', url = "https://t.me/majeed8888"},{text = '𝗗𝗲𝗩𝟐', url = "https://t.me/majeed8888"}
},
{
{text = ' 𝘀𝗼𝘂𝗿𝗿𝗰', url = "https://t.me/majeed8888"}
},
}
...
{
{text = '• قناة السورس', url = 't.me/MAJEED8888'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
if text == (Redis:get(relax.."relax:Name:Bot") or "مجيد") then
local NamesBot = (Redis:get(relax.."relax:Name:Bot") or "مجيد")
local NameBots = {
"مجيد "..NamesBot.. " كيف اخدمك",
"بوت مجيد المساعد .. كيف اقدر اخدمك",
"بوت مجيد المساعد .. كيف اقدر اخدمك",
"بوت مجيد المساعد .. كيف اقدر اخدمك",
"بوت مجيد المساعد .. كيف اقدر اخدمك "..NamesBot,
'بوت مجيد المساعد .. كيف اقدر اخدمك'
}
...
Redis:set(relax.."relax:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
...
Redis:set(relax.."relax:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح تعديلاتي')
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(relax.."relax:Name:Bot") or "مجيد")..
